    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <div class="border-faded bg-faded p-3 mb-g d-flex mt-3">
                        <input type="text" id="search" name="filter-contacts" class="form-control shadow-inset-2 form-control-lg" placeholder="Найти пользователя">
            ...
            <div class="row" id="js-contacts">
                ...
                <div class="col-xl-4">
                    <div id="output" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $var['search'];?>">
